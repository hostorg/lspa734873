...
// for logo change hide image update
...
// });
    ...
    function toggleEditableClasses(enable) {
        ...
        if (enable) {
            ...
            wrapper.find('.generated-logo').addClass('updateTextLogo');   //New code for updated logo
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status === 200) {
                ...
                // window.location.href = `/es/?srcReq=${currentPage}`;
            } else {
