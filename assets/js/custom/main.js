...
$(document).ready(function () {
    ...
    // SHOW EXISTING TEMPLATE SECTION
    $("#existingTemplateSection").show();

    // HIDE CUSTOMIZE TEMPLATE SECTION
    $("#customizeTemplateSection").hide();
...
$(document).on('click', '.template-card', function() {
    ...
    if (selectedOption === 'customize') {
        ...
        $("#existingTemplateSection").hide();
        $("#customizeTemplateSection").show();
  ...
  CURRENT_MODE = selectedValue;
    ...
    if (selectedValue === 'header') {
            if (CURRENT_MODE === "customize") {
                ...
                if (!selectedHeader) {
                    showAlert("Please select one of the Headers from the available options given below.");
                    return;
                }
